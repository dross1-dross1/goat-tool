...
This is a line with search_term.
aaaaaaaaaaaaaaaaaabbbb cccdde
Error: Cannot print a directory 'test_files'."
...
"Error: Cannot get the size of a directory."

    printMsg 1 "[-z] Test case: File with permission denied (locked file)"
...
"Error: Invalid command switch or missing arguments. Use -h for help."
    ...
    printMsg 1 "[-m] Test case: Merge with a file with permission denied"
...
"Error: Invalid file type for 'test_files'. It is a directory."
...
"Error: Cannot compress a directory."

    printMsg 1 "[-c] Test case: File with permission denied (locked file)"
...
"Error: Cannot decompress a directory."

    printMsg 1 "[-d] Test case: .goat file with permission denied"
